...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void PlayFootStepAudio()
		{
			...
			{
				if (hit.collider.CompareTag("floorCarpet"))
				{
					//do carpet
					playStep(m_FootstepSoundsCarpet);
				}
				else if (hit.collider.CompareTag("floorWood"))
				{
					//do wood
					playStep(m_FootstepSoundsWood);
				}
				else
				{
					//do wood
		...
		private void playStep(AudioClip[] audioClips)
		{
